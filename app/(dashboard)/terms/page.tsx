...
export default function Terms() {
  return (
    <main className="mx-auto max-w-[72ch] px-6 py-16 text-graphite-500">
      <h1 className="mb-10 text-graphite-900">Terms of Service</h1>
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">1. Acceptance of Terms</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">2. Changes to Terms</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">3. Use of the Site</h2>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">4. Intellectual Property</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">5. Privacy</h2>
        <p>
          Your use of the Site is also governed by our <a href="/privacy" className="text-signal-700 underline underline-offset-4 hover:text-signal-600">Privacy Policy</a>.
        </p>
      </section>

      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">6. Disclaimers</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">7. Limitation of Liability</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-h4 text-graphite-900">9. Contact Us</h2>
        <p>
